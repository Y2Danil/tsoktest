    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_author', models.TextField(blank=True, max_length=100, null=True, verbose_name='Автор идеи')),
                ('title', models.TextField(blank=True, max_length=48, null=True, verbose_name='Название статьи')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(db_index=True, max_length=30, unique=True, verbose_name='Название')),
            ],
            options={
